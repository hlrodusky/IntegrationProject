...
# I want to calculate the maximum travel and hotel cost the user is willing
# to spend I will use addition
print("---------------------------------------------")

# I also want to determine how many days the user wants to stay.
print("Lets calculate your maximum cost and stay")
airfare = float(input(
    "Enter the maximum amount you are willing to spend on airfare and or "
    "gas: "))
hotel = float(input(
    "Enter the total maximum amount you are willing to spend on a "
    "hotel/airbnb: "))
...
totalCost = airfare + hotel
print("---------------------------------------------")

print("Cost of airfare/gas: ", format(airfare, ".2f"), sep='')
...
print("The estimated cost per day is: $", format(estimateCostPerDay, ".2f"),
      sep="")
...
missedDays = int(input(
    "Enter the amount of days you think you may lose due to rain or a "
    "delayed flight: "))
totalMissedDays = days - missedDays
print("This is how many days you'll actually have:", totalMissedDays)
print("---------------------------------------------")

# I want the user to see how far they are willing to travel in the area in
# relation to their hotel I will use the exponent operator and the area of a
# circle formula (A=3.14159*r**2)
print(
    "Next you will calculate the area you can cover, with your hotel as the "
    "center")
distance = float(input(
    "How many miles are you willing to travel from the distance of your "
    "hotel: "))
pi = float(3.14159)
area = pi * distance ** 2
miles = 'mi.'
print("The total area you can travel, with your hotel as the center point is:",
      format(area, ".2f") + " " + miles)
print("---------------------------------------------")

# now I will figure out how far they want to travel
print("Next you will determine how far you want to travel")
distanceFromHome = float(
    input("How many miles do you want to travel from home:"))
...
print("Now we will determine the destination")
...
if (weather == 'warm') and (idealTime != 'fall', 'autumn', 'winter'):
    if (distanceFromHome >= 1) and (distanceFromHome <= 3000):
        print(
            "Florida, Maine, Massachusetts, Hawaii, California, and New York "
            "may interest you!")
    else:
        print(
            "London, Peru, Canada, Jamaica, Japan, and Italy may interest"
            " you!")
elif (weather == 'warm') and (idealTime == 'fall', 'autumn', 'winter'):
    if (distanceFromHome >= 1) and (distanceFromHome <= 3000):
        print(
            "Florida, California, Hawaii, Texas, and Arizona may interest"
            " you!")
    else:
        print(
            "Aruba, Mexico, The Bahamas, Colombia, and Indonesia may "
            "interest you!")
elif (weather == 'cold') and (idealTime != 'fall', 'autumn', 'winter'):
    if (distanceFromHome >= 1) and (distanceFromHome <= 3000):
        print(
            "Colorado, Alaska, Michigan, Oregon, and Illinois may interest "
            "you!")
    else:
        print(
            "Iceland, Australia, South Africa, Canada, and Chile may "
            "interest you!")
elif (weather == 'cold') and (idealTime == 'fall', 'autumn', 'winter'):
    if (distanceFromHome >= 1) and (distanceFromHome <= 3000):
        print(
            "Vermont, Maryland, New Jersey, Ohio, and Washington may "
            "interest you!")
    else:
        print(
            "Amsterdam, Greece, Sweden, Switzerland, and Poland may interest "
            "you!")
print("Yay! now we have narrowed it down a bit!")

# I will determine what the user wants to do while on vacation through with
# two options
print("---------------------------------------------")
print("Let's find one activity that could be fun while on vacation")
print(
    "Option 1 is go downtown/the city, and option 2 is go to the beach/going "
    "outside")
optionOne = 0
while optionOne:
    userOption = input("What option would you like to do, 1 or 2?: ")
    if userOption != 1:
...
def calculateCost(MealPerPerson, WhoIsGoing):
    """
    This function calculates cost of meals per person and give the grand
    total for everyone :param MealPerPerson: :param WhoIsGoing: :return:
    """
...
This calls the function
    """
    MealPerPerson = float(input(
        "what is the maximum cost you are willing to spend on one meal?: "))
    WhoIsGoing = int(input(
        "How many people are you bringing on the trip, including yourself?: "))
    result = calculateCost(MealPerPerson, WhoIsGoing)
    print("Three meals per person, for everyone is a total of:$",
          format(result, '.2f'), sep='')


main()

# I will take a break from the program to make sure the user is paying
# attention this code was in pogil 10
print("---------------------------------------------")
...
if travelType == ("yes" or "y") or (travelType == (not ("no" or "n"))):
    print(
        "You should check out tourist spots at the visitors center for your "
        "destination!")
else:
